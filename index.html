...
<body>
    ...
    <section class="estudante">
        ...
        <div class="estudante-div">
            <img class="estudante-imagem" src="./img/mulher1.jpg" alt="foto mulher1">
            <h3 class="estudante-nome">Ana</h3>
            <a href="https://github.com"><img class="estudante-icone" src="./img/github.png" alt="icone github"></a>
            <a href="https://linkedin.com"><img class="estudante-icone" src="./img/linkedin.png" alt="icone linkedin"></a>
            <a href="https://instagram.com"><img class="estudante-icone" src="./img/instagram.png" alt="icone instagram"></a>
        </div>
        <div class="estudante-div">
            <img class="estudante-imagem" src="./img/mulher2.jpg" alt="foto mulher2">
        ...
        <div class="estudante-div">
            <img class="estudante-imagem" src="./img/homem1.jpg" alt="foto homem1">
